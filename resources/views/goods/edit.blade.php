...
@section('title')
    <h1>{!! __('goods.titles.edit_good') !!}</h1>
    @stop

@section('content')

    {!! Form::open(['url' => 'goods/update/'.$good->id, 'class' => 'form-horizontal', 'files' => true]) !!}
    {{ csrf_field() }}
    {!! Form::hidden('image', $good->image) !!}

    <div class="form-group{{ $errors->has('name_ru') ? ' has-error' : '' }}">
        {!! Form::label('name_ru', __('goods.fields.name').' (RU) ', ['class' => 'col-md-4 control-label']) !!}
        <div class="col-md-6">
            {!! Form::text('name_ru', $good->name_ru, ['class' => 'form-control']) !!}
    ...
    <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::text('name_en', $good->name_en, ['class' => 'form-control']) !!}
    ...
    <div class="form-group{{ $errors->has('description_ru') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::textarea('description_ru', $good->description_ru, ['class' => 'form-control', 'style' => 'resize: vertical', 'rows' => '6']) !!}
    ...
    <div class="form-group{{ $errors->has('description_en') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::textarea('description_en', $good->description_en, ['class' => 'form-control', 'style' => 'resize: vertical', 'rows' => '6']) !!}
    ...
    <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::number('amount', $good->amount, ['class' => 'form-control']) !!}
    ...
    <div class="form-group">
        <div class="text-center">
            {!! Form::submit(__('goods.buttons.edit'), ['class' => 'button']) !!}
        </div>
    </div>
    {!! Form::close() !!}
