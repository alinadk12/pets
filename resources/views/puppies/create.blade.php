...
@section('title')
    <h1>{!! __('puppies.titles.new_puppy') !!}</h1>
@stop

@section('content')

    {!! Form::open(['url' => 'puppies/store', 'class' => 'form-horizontal', 'files' => true]) !!}
    {{ csrf_field() }}
    ...
    <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {{ Form::radio('gender', '1', true) }} {!! __('puppies.fields.genders.male') !!}<br>
            {{ Form::radio('gender', '0') }} {!! __('puppies.fields.genders.female') !!}
        </div>
    </div>
    <div class="form-group{{ $errors->has('birthdate') ? ' has-error' : '' }}">
        {!! Form::label('birthdate', __('puppies.fields.birthdate').' ', ['class' => 'col-md-4 control-label']) !!}
        <div class="col-md-6">
    ...
    <div class="form-group{{ $errors->has('notes_ru') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::textarea('notes_ru', old('notes_ru'), ['class' => 'form-control', 'style' => 'resize: vertical', 'rows' => '6']) !!}
    ...
    <div class="form-group{{ $errors->has('notes_en') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::textarea('notes_en', old('notes_en'), ['class' => 'form-control', 'style' => 'resize: vertical', 'rows' => '6']) !!}
    ...
    <div class="form-group">
        <div class="text-center">
            {!! Form::submit(__('puppies.buttons.create'), ['class' => 'button']) !!}
        </div>
    </div>
    {!! Form::close() !!}
